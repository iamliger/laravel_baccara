<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ __('새 Logic-2 패턴 추가') }}</h2>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.logic2.store') }}">
                        @csrf
                        <!-- 이름 -->
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="sequence" type="text" name="sequence" value="{{ old('sequence') }}" required placeholder="예: 1,-1,1,1"
                                   class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        </div>
                        <!-- 활성 상태 -->
                        <div class="mt-4">
